...
.user-hero::before{content:'';position:absolute;top:0;left:0;right:0;height:4px;
  background:linear-gradient(90deg,#CBD5E1,#1E293B,#CBD5E1);}
...
.stat-mini-lbl{font-size:0.72rem;text-transform:uppercase;letter-spacing:1px;color:#000000;font-weight:700;}
...
if did_status == "ready":
    ...
    did_badge = '<span style="display:inline-block;background:#1E293B;color:#FFFFFF;font-size:0.7rem;font-weight:700;padding:0.25rem 0.7rem;border-radius:20px;margin-left:0.5rem;">⚪ DID Not Verified</span>'
...
<div class="user-hero">
  <div style="display:flex;align-items:center;gap:1.5rem;">
    ...
    <div style="text-align:right;">
      ...
      <div style="font-size:0.75rem;text-transform:uppercase;letter-spacing:1px;color:#000000;font-weight:700;">Total Spend (USD)</div>
    </div>
  </div>
</div>
""", unsafe_allow_html=True)
...
with r1:
    ...
    if not u_bills.empty and "status" in u_bills.columns:
        ...
        fig.update_layout(
            ...
            yaxis=dict(gridcolor="rgba(0,0,0,0.0)", tickfont=dict(size=12, color="#1E293B")),
            showlegend=False,
        )
